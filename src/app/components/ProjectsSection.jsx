    ...
    const projects = [
        {
          ...
          description: "Technical Task that was given to me during my internship at BLINC Technologies Corporation",
        ...
        },
        {
            ...
            description: "Another technical Task that was given to me during my internship at BLINC Technologies Corporation",
            techStack: ["bootstrap", "html", "scss", "css", "js"],
            images: [tt2],
          ...
          },
        {
          id: 3,
          name: "STEADY",
          description: "An android application featuring map navigation, news integration, and statistics for landslides and eathquakes around Baguio City ",
        ...
        },
        {
          id: 3,
          name: "UCGC",
          description: "A Web application geared towards communication between University of the Cordilleras' students and guidance counselors. It features a chat system, booking system, and real - time email notifications, aiming to digitize the counseling process.",
        ...
        },
        {
            ...
            description: "A simple animation of a penguin using HTML, CSS, and JavaScript, made as an activity for my Web Development class",
      ...
      <section className="space-y-14 scroll-mt-[4rem]" id="projects">
        <div className="flex justify-center items-center space-x-4">
          ...
          <div className="border p-4 rounded-lg shadow-lg" id="projectCard">
            ...
            <div className="flex gap-2 mt-4">
              <Link href={activeProject.link} target="_blank" className="text-blue-500">
                Live Demo
              </Link>
              <Link href={activeProject.github} target="_blank" className="text-blue-500">
                GitHub
              </Link>
              {activeProject.figma && (
                <Link href={activeProject.figma} target="_blank" className="text-blue-500">
                  Figma
                </Link>
              )}
            </div>
        ...
        {showAllImages && (
          <div className="mt-8 space-y-4">
            <h4 className="text-lg font-semibold">All Images for {activeProject.name}</h4>
